...
\begin{enumerate}
\item dass wir {\meineArbeit} {\arbeit} mit dem Thema
{\itshape \titel } ohne fremde Hilfe angefertigt haben;
\item dass wie die Übernahme wörtlicher Zitate aus der Literatur sowie die Verwendung der Gedanken
anderer Autoren an den entsprechenden Stellen innerhalb der Arbeit gekennzeichnet haben;
\item dass wir {\meineArbeit} {\arbeit} bei keiner anderen Prüfung vorgelegt haben;
